...
# Inclusion
```{r}
inc_table%>%knitr::kable(format = 'pipe')%>%print()
```
...
names(ren_MV_COX_res$coefficients)<-c('BSI','ECPR','Age','Malignancy','LDH','BUN','CRP','Segmented neutrophil','Lactate at 24hr','CRRT','VV-ECMO')
